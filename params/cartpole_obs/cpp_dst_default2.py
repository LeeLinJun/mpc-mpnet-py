...
def get_params():
    params = {
        ...
        # "cost_predictor_weight_path": "mpnet/exported/output/cartpole_obs/cost_to_go_obs.pt",

        "cost_to_go_predictor_weight_path": "mpnet/exported/output/cartpole_obs/cost_to_go_aug.pt",
