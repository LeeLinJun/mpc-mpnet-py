...
def main(args):
    if args.env_name == 'quadrotor_obs':
        ...
        obs_list, obc_list = quadrotor_obs_gen.obs_gen_unseen(None, None, N_pc=40000, width=width)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path_folder', type=str, default='./trajectories/quadrotor_obs_generalize/')
    ...
    parser.add_argument('--obs_file', type=str, default='./trajectories/quadrotor_obs_generalize/obs.pkl')
    parser.add_argument('--obc_file', type=str, default='./trajectories/quadrotor_obs_generalize/obc.pkl')
