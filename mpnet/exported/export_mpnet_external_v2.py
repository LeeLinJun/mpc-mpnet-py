...
class MLP(nn.Module):
    def __init__(self, input_size=136, output_size=4):
...
def main(system_env, system, setup, ep, outputfn):
    ...
    mpnet = KMPNet(total_input_size=8, AE_input_size=32, mlp_input_size=136, output_size=4, CAE=Encoder, MLP=MLP2)
    mpnet.cuda()
    ...
    load_func(mpnet, '/media/arclabdl1/HD1/YLmiao/results/KMPnet_res/cartpole_obs_2_lr0.001000_Adagrad_loss_l1_smooth_step_200/kmpnet_epoch_9950_direction_0_step_200.pkl')
    mpnet.train()
    # mpnet.eval()
