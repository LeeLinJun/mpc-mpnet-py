...
def main(system_env, system, setup, ep, outputfn):
    ...
    load_func(mpnet, '/media/arclabdl1/HD1/YLmiao/results/KMPnet_res/cartpole_obs_3_lr0.001000_Adagrad_loss_l1_smooth_step_200/kmpnet_epoch_9950_direction_0_step_200.pkl')
