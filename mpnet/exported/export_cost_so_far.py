...
def main(system, model, setup, ep):
    ...
    costnet.load_state_dict(torch.load('output/{}/{}/cost_so_far/ep{}.pth'.format(model, setup, ep)))
    costnet.eval()
    export(costnet, setup=setup, system=system, model=model, exported_path="exported/output/cost_so_far_10k.pt")
