...
def main(system_env, system, setup, ep, outputfn):
    ...
    mpnet_p = KMPNet(total_input_size=8, AE_input_size=32, mlp_input_size=136, output_size=2, CAE=Encoder, MLP=MLP2)
    mpnet_p.cuda()
    mpnet_v = KMPNet(total_input_size=8, AE_input_size=32, mlp_input_size=136, output_size=2, CAE=Encoder, MLP=MLP2)
    mpnet_v.cuda()
    ...
    load_func(mpnet_p, '/media/arclabdl1/HD1/YLmiao/results/KMPnet_res/cartpole_obs_2_lr0.001000_Adagrad_loss_l1_smooth_step_200/kmpnet_pnet_epoch_1300_direction_0_step_200.pkl')
    load_func(mpnet_v, '/media/arclabdl1/HD1/YLmiao/results/KMPnet_res/cartpole_obs_2_lr0.001000_Adagrad_loss_l1_smooth_step_200/kmpnet_vnet_epoch_1300_direction_0_step_200.pkl')
    mpnet_p.train()
    mpnet_v.train()
