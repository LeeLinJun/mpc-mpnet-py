...
def main(system, model, setup, ep):
    ...
    costnet.load_state_dict(torch.load('output/{}/{}/costnet/ep{}'.format(model, setup, ep)))
    costnet.eval()
    export(costnet, setup=setup, system=system, model=model, exported_path="exported/output/costnet5000.pt")
